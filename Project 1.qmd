...
summary.census <- function(data, 
  ...
  # Summarize categorical variables - using vectorization
  categorical_summary <- data %>%
    select(all_of(categorical_vars)) %>%
    summarise(across(everything(), ~ list(counts = table(.))))

  # Combine numeric and categorical summaries into one list
  summary_list <- c(summary_list, as.list(categorical_summary))
