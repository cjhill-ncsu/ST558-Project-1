...
As mentioned, this was collaborative effort. The project is housed in a GIT repository to facilitate this. Because of the small size of our team we had success when development was done off the main branch. A development branch was created to explore the option of merging, but it proved to be more difficult than necessary for our workflow.
