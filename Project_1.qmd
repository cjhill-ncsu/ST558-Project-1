...
To showcase our multi-year function, we will view the gross rent as a percentage of household income over the last 12 months (GRPIP) in New England, from 2016 through 2018, by whether they have given birth within the last 12 months (FER). We display an aggregate of the results, so that the stratification by year can be seen.
